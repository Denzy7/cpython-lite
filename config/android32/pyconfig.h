...
//Use 21 for best chances of build success
...
/* Define if you have the 0readline library (-lreadline). */
...
/* Define to 1 if you have the `l' function. */
